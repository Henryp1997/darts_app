...
def layout():
    return html.Div([
            ...
            html.Div([
                ...
                html.Div("......", style={"color": "black", "display": "inline-block"}),
                html.Div("_____", id="dart_1_bp", style={"color": "white", "display": "inline-block"}),
                html.Div("......", style={"color": "black", "display": "inline-block"}),
                html.Div("_____", id="dart_2_bp", style={"color": "white", "display": "inline-block"}),
                html.Div("......", style={"color": "black", "display": "inline-block"}),
                html.Div("_____", id="dart_3_bp", style={"color": "white", "display": "inline-block"}),
                html.Div(style={"height": "0.5rem"}),
            ...
            html.Div([
                html.Div(style={"height": "0.5rem"}),
                html.Div("..", style={"color": "black", "display": "inline-block"}),
                html.Div("Bull hits (current session):", style={"color": "white", "display": "inline-block"}),
                html.Div("aaaaa", style={"color": "black", "display": "inline-block"}),
                html.Div("_____", id="bull_hits_current", style={"color": "white", "display": "inline-block"}),
                html.Div(style={"height": "0.5rem"}),
            ], style={"border": "2px solid #fff"}),
            html.Div(style={"height": "0.5rem"}),
            ...
            html.Div([
                html.Div(style={"height": "0.5rem"}),
                html.Div("..", style={"color": "black", "display": "inline-block"}),
                html.Div("25 hits (current session):", style={"color": "white", "display": "inline-block"}),
                html.Div("aaaaaa.", style={"color": "black", "display": "inline-block"}),
                html.Div("_____", id="25_hits_current", style={"color": "white", "display": "inline-block"}),
                html.Div(style={"height": "0.5rem"}),
            ], style={"border": "2px solid #fff"}),
            html.Div(style={"height": "0.5rem"}),
            ...
            html.Div([
                html.Div(style={"height": "0.5rem"}),
                html.Div("..", style={"color": "black", "display": "inline-block"}),
                html.Div("Bull hits (all time):", style={"color": "white", "display": "inline-block"}),
                html.Div("aaaaaaaaaaa.", style={"color": "black", "display": "inline-block"}),
                html.Div("_____", id="bull_hits_all", style={"color": "white", "display": "inline-block"}),
                html.Div(style={"height": "0.5rem"}),
            ], style={"border": "2px solid #fff"}),
            html.Div(style={"height": "0.5rem"}),
            ...
            html.Div([
                html.Div(style={"height": "0.5rem"}),
                html.Div("..", style={"color": "black", "display": "inline-block"}),
                html.Div("25 hits (all time):", style={"color": "white", "display": "inline-block"}),
                html.Div("aaaaaaaaaaaa..", style={"color": "black", "display": "inline-block"}),
                html.Div("_____", id="25_hits_all", style={"color": "white", "display": "inline-block"}),
                html.Div(style={"height": "0.5rem"}),
            ], style={"border": "2px solid #fff"}),
            html.Div(style={"height": "0.5rem"}),
